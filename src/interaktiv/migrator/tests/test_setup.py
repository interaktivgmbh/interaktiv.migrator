...
from interaktiv.migrator.testing import \
...
class TestUninstall(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.portal = self.layer['portal']
        self.qi_tool = getToolByName(self.portal, 'portal_quickinstaller')
        self.qi_tool.uninstallProducts(products=['interaktiv.migrator'])

    def test_uninstalled(self):
        self.assertFalse(
            self.qi_tool.isProductInstalled('interaktiv.migrator')
        )
